(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".services__slider")) {
            ...
            function updateScrollbar(swiperInstance) {
                ...
                if (isMobile) {
                    ...
                    const scrollbarTop = currentIndex / (totalSlides - 1) * (swiperInstance.height - 30 - scrollbarSize);
        ...
        function initializeProcessSlider() {
            ...
            if (isMobile) {
                if (!document.querySelector(".process__slider").swiper) processSwiper = new Swiper(".process__slider", {
            ...
            function updateScrollbar(swiperInstance) {
                const totalSlides = swiperInstance.slides.length;
                const currentIndex = swiperInstance.activeIndex;
                const scrollbar = document.querySelector(".process-scrollbar");
                const scrollbarHeight = 50;
                const scrollbarTop = currentIndex / (totalSlides - 1) * (swiperInstance.height - scrollbarHeight);
                scrollbar.style.top = `${scrollbarTop}px`;
            }
        }
